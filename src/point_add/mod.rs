...
pub fn build() -> Vec<Op> {
    ...
    // expectation ~7e-3 (rounds 3.9e-3, fold 1.3e-3, flag 3e-4, chunk 1.6e-3).
    set_default_env("SUB4_PP_ROUNDS", "760");
    set_default_env("SUB4_PP_ROUNDS_MUL", "760");
    ...
    set_default_env("SUB4_PP_PEAK", "1341");
    set_default_env("SUB4_PP_WALK_PEAK", "1341");
    set_default_env("SUB4_PP_REPLAY_CHUNK", "96");
    set_default_env("SUB4_PP_REPLAY_CHUNK_COMPARE", "34");
